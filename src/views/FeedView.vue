    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
     ...
     <div class="main-center col-span-2 space-y-4">
        <div class="bg-white border border-gray-200 text-center rounded-lg">
            <div class="p-4">  
             ...
             <div class="p-4 border-t border-gray-100 flex justify-between">
                 <a href="#" class="inline-block py-2 px-6 bg-gray-600 text-white rounded-lg">Suggest a trip</a>
                  <a href="#" class="inline-block py-2 px-6 bg-purple-600 text-white rounded-lg">Post</a>
             </div>
        </div>
        ...
        <div class="p-4 bg-white border border-gray-200 rounded-lg">
                        ...
                        <p>What the next destination?</p><br>
                        <img src="https://images.unsplash.com/photo-1678899091039-9950e7f248b5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="w-full rounded-lg">
